...
generate-imandra-http-api-client:
	docker run -u $(id -u):$(id -g) --rm -v ${PWD}:/local openapitools/openapi-generator-cli  generate -i /local/imandra_http_api_client.swagger.yaml -g ocaml -o /local  -p packageName=imandra_http_api_client -p generateSourceCodeOnly=true 
